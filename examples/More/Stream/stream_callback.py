...
if __name__ == "__main__":
    ...
    try:
        ...
        if deviceType == ljm.constants.dtT4:
            ...
            aNames = ["AIN0_RANGE", "STREAM_SETTLING_US", "STREAM_RESOLUTION_INDEX"]
            aValues = [10.0, 0, 0]
        else:
        ...
        si.scanRate = ljm.eStreamStart(
            handle, si.scansPerRead, si.numAddresses, si.aScanList, si.scanRate
        )
        ...
        printWithLock(
            "Waiting until eStreamRead has been called %d times."
